...
public:
	...
	{
		Matrix scale = Matrix::Scaling(interpolate(frames[baseFrame].scales[boneIndex],
		...
		Matrix translation = Matrix::Translate(interpolate(frames[baseFrame].positions[boneIndex],
